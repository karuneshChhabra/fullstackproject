...
const {getOrderById,createOrder,updateStatus,getAllOrders}= require("../controllers/order");
...
router.get("/order/status/:userId",isSignedIn,isAuthenticated,isAdmin,getAllOrders)
